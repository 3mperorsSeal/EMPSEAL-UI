    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-1 shrink-0">
          <div className="relative hidden">
            ...
            >
              <span
                ...
                style={{ background: selectedNetwork.color, borderRadius: 0 }}
              />
              ...
              >
                {NETWORKS.map((n) => (
                  ...
                  >
                    <span
                      className="w-1.5 h-1.5"
                      style={{ background: n.color, borderRadius: 0 }}
                    />
                    {n.name}
                    {selectedNetwork.id === n.id && (
                      <span className="ml-auto" style={{ color: "#FF8A00" }}>
                        &#10003;
                      </span>
                    )}
                  </button>
          ...
          <div className="relative hidden">
            <button
              ...
              style={{
                ...
                color: settingsOpen ? "#FF8A00" : "rgba(255,255,255,0.3)",
                cursor: "pointer",
              }}
            >
              <svg
                  ...
                  <div style={{ padding: "16px" }}>
                    ...
                    <div className="flex gap-1" style={{ marginBottom: 16 }}>
                      ...
                      <input
                        ...
                        placeholder="Custom"
                        value={
                          !["0.1", "0.5", "1.0"].includes(settingsSlippage)
                            ? settingsSlippage
                            : ""
                        }
                        onChange={(e) =>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={() => setSettingsExpert(!settingsExpert)}
                        style={{
                          width: 36,
                          height: 20,
                          borderRadius: 0,
          ...
          {/* Wallet */}
          <button
            className="flex items-center gap-2 transition-all pointer-events-none opacity-0 w-[160px]"
            style={{
              padding: "5px 12px",
              borderRadius: 0,
              fontSize: 11,
          ...
          >
            <span
              ...
              style={{ background: "#FF8A00", borderRadius: 0 }}
            />
            <span
              style={{
                ...
                return (
                  <Link
                    ...
                    style={{
                      ...
                      fontSize: 12,
                      fontWeight: active ? 700 : 500,
                      color: active ? "#FF8A00" : "rgba(255,255,255,0.35)",
                      letterSpacing: "0.1em",
                      textTransform: "uppercase",
                      borderBottom:
