export const getChainConfig = (chainId: number) => {
  switch (chainId) {
    ...
    case 56:
      return {
        routerAddress:
          "0x7b9637C7c8Aa45B679eEdBb4b680642410322df1" as `0x${string}`,
        wethAddress:
    ...
    case 143:
      return {
        routerAddress:
          "0x867c1fd9341DEC12e4B779C35D7b7C475316b334" as `0x${string}`,
        wethAddress:
    ...
    case 42161:
      return {
        routerAddress:
          "0xA7772cDBA7739F19dcaE85fe0357929790FD23F9" as `0x${string}`,
        wethAddress:
    ...
    case 10: 
      return {
        routerAddress:
          "0x686c652d079A370eC97F93B2b4805Ee06aE25d04" as `0x${string}`,
        wethAddress:
          "0x4200000000000000000000000000000000000006" as `0x${string}`,
      };
    case 137: 
      return {
        routerAddress:
          "0x9a64E7a18f5A9edcE3A3728B2C12643FA0cee26B" as `0x${string}`,
        wethAddress:
          "0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270" as `0x${string}`,
      };
    case 43114:
      return {
        routerAddress:
          "0xf4e53aAe1D9f27851B03842007D0a8a023317cD2" as `0x${string}`,
        wethAddress:
          "0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7" as `0x${string}`,
      };
    default:
