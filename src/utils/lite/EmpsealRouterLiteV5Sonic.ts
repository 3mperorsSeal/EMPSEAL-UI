/**
 * EmpsealRouter V5 ABI for Sonic Chain
 * Uses universal ETH naming convention (swapNoSplitFromETH, swapNoSplitToETH)
 * Includes executeConvergeSwap and executeSplitSwap for new routing strategies
 */
export const EmpsealRouterLiteV5Sonic = [
    {
        "inputs": [
            {
