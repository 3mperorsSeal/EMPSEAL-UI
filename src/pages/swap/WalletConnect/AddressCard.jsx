...
export default function AddressCard({
  ...
  return (
    <div
      ref={popupRef}
      className="relative bg-black text-white md:p-12 p-6 rounded-2xl clip-bg flex flex-col items-center gap-4 md:max-w-[430px] w-full border border-[#FF9900] shadow-[0_0_20px_#FF9900]"
    >
      <svg
        onClick={onClose}
