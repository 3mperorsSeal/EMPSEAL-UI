...
const TradeDataCard = ({
  ...
  return (
    <>
            <div className='absolute bg-white left-0 bottom-20 border-4 border-l-2 border-[#FF9900] py-7 px-10 rounded-lg'>
        <h6 className='font-orbitron text-sm'>
          <span><span className='font-semibold'>Min Received</span> : <span className='font-bold'>{formatNumber(minReceived)}</span> {tokenB.symbol}</span>
        </h6>
                <h6 className='font-orbitron text-sm py-2'>
          <span><span className='font-semibold'>Price in :</span> <span className='font-bold'>{usdAmount} {"$"}</span></span>
        </h6>
                <h6 className='font-orbitron text-sm'>
          <span><span className='font-semibold'>Price Impact :</span> <span className='font-bold'>{priceImpact} %</span></span>
        </h6>
      </div>
    </>
  );
